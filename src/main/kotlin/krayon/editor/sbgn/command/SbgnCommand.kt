...
abstract class SbgnCommand(id:String, scope:CommandScope = CommandScope.DEFAULT) : ApplicationCommand(id, scope) {
    val sbgnGraphComponent get() = graphComponent as SbgnGraphComponent
}